...
$(document).ready(function () {
    ...
    for (var i = 0; i < 3; i++)
        tanksArray[i] = new Tanque(tanks.tanque[i].modelo, tanks.tanque[i].fabricante, tanks.tanque[i].pais, tanks.tanque[i].tipo, tanks.tanque[i].velocidad, tanks.tanque[i].artilleria, tanks.tanque[i].peso, tanks.tanque[i].longitud, tanks.tanque[i].anchura, tanks.tanque[i].altura, tanks.tanque[i].tripulacion);
    
    console.log(tanksArray[2].getModelo())
    console.log(tanksArray[0].getPais())
    console.log(tanksArray[1].getVelocidad())
