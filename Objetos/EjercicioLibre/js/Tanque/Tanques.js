//Importamos la clase Tanque
import { Tanque } from './Tanque.js';

//Esperamos a que cargue el documento entero
$(document).ready(function () {
    //Creamos un array en el que meter los tanques
    let tanksArray = [];
    //Metemos el JSON en una varibale
    ...
    //Pasamos el JSON a un array
    let tanks = JSON.parse(tanques);
    //Metemos la informacion en objetos y metemos estos objetos a al primer array
    for (let i = 0; i < 3; i++)
    ...
    //Cremos la tabla para mostrar la informacion de los tanques
    ...
    tabla += "</tr>";
    //Hacemos un bucle por cada tanque que tengamos y metemos su informacion en una fila de la tabla
